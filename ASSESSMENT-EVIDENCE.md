...
| Configuration management | Ansible playbook | Syntax validation and idempotency verification | [Ansible configuration](https://github.com/Yemane1426/northwind-logistics-devops/tree/main/ansible), [Ansible syntax check](https://github.com/Yemane1426/northwind-logistics-devops/blob/main/evidence/ansible-syntax-check.txt), [Ansible first run](https://github.com/Yemane1426/northwind-logistics-devops/blob/main/evidence/ansible-first-run.txt), [Ansible idempotency run](https://github.com/Yemane1426/northwind-logistics-devops/blob/main/evidence/ansible-idempotency-run.txt) |
...
- Ansible configuration: https://github.com/Yemane1426/northwind-logistics-devops/tree/main/ansible
- Ansible syntax check: https://github.com/Yemane1426/northwind-logistics-devops/blob/main/evidence/ansible-syntax-check.txt
- Ansible first run: https://github.com/Yemane1426/northwind-logistics-devops/blob/main/evidence/ansible-first-run.txt
- Ansible idempotency run: https://github.com/Yemane1426/northwind-logistics-devops/blob/main/evidence/ansible-idempotency-run.txt
